...
import icon1 from '../../assets/hercoPowerImages/abouticon1.png'
import icon2 from '../../assets/hercoPowerImages/abouticon2.png'
    ...
    <div>
      {/* <div>
        ...
        <div className="md:hidden">
          <p className="text-xs md:text-sm font-inter opacity-60 leading-5 md:leading-7 text-justify md:text-left m-0">
      ...
      <div className="h-[99%]">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-16 h-full">
            ...
            return (
              ...
              >
                <div className="p-5">
                  ...
                  <span className="text-center text-sm font-inter opacity-60 leading-7 flex justify-center items-center">
                    {item?.desc}
                  </span>
                </div>
              </div>
