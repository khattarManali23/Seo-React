      ...
      >
        <div className="w-full h-fit">
          ...
          <div className="w-[100%] mx-auto flex justify-center">
            <div className="relative border-dark-grey border-b-2 flex items-center w-11/12 sm:w-8/12 h-14 sm:h-20 focus-within:shadow-shadow-medium bg-white overflow-hidden">
              <input
                className="peer h-full w-full outline-none font-robo text-gray-700 pl-3 text-base sm:text-2xl"
                type="text"
                id="search"
                style={{
                  background: 'white',
