        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <div className="w-full sm:w-11/12">
            <div className="">
              ...
              <p className="mb-6 text-justify font-inter  text-base leading-9 sm:text-left">
              ...
              <p className="mb-6 font-inter  text-base leading-9">
        ...
        <div className=" mx-auto w-full sm:w-10/12">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className="mt-10 hidden  h-full w-full sm:block">
              <p className="mb-6 font-inter  text-base leading-9 text-white">
